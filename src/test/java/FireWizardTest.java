...
import characters.spellCasters.IceWizard;
import items.Staff;
...
public class FireWizardTest {

    private IceWizard wizard;
    ...
    @Before
    public void before(){
        wizard = new IceWizard("IceWizard", 5);
    ...
    public void wizardNameAndHealth(){
        assertEquals("IceWizard", wizard.getName());
